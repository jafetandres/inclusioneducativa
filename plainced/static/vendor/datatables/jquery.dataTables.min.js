...
(function (h) {
    ...
    function Jb(a) {
        for (var b, c, d = a.aoColumns, e = X(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
            ...
            c.bSortable && (0 < e.length && e[0].col == f ? (i.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending" : "descending"), c = j[e[0].base + 1] || j[0]) : c = j[0], b += "asc" === c ? a.sSortAscending : a.sSortDescending);
    ...
    var n = function (a) {
            ...
            this.fnGetPosition = function (a) {
                ...
                return "TR" == c ? b.row(a).base() : "TD" == c || "TH" == c ? (a = b.cell(a).base(), [a.row, a.columnVisible, a.column]) : null
            };
    ...
    var ab = function (a, b, c, d, e) {
        ...
        } else if ("home.html" == c || "original" == c) {
            c = 0;
    ...
    u("rows().indexes()", "row().base()", function () {
        return this.iterator("row",
            function (a, b) {
                return b
            }, 1)
    ...
    u("cells().indexes()", "cell().base()", function () {
        return this.iterator("cell", function (a, b, c) {
